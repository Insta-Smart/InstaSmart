...
class LoginMessages with ChangeNotifier {
  ...
  static const defaultDontHaveAccount = "Don't have an account yet?";
  static const defaultLoginButton = 'LOGIN';
  static const defaultSignupButton = 'SIGNUP';
  static const signUpWithFacebookButton = 'Connect with Facebook';
  static const signUpWithGoogleButton = "Connect with Google";
  static const defaultRecoverPasswordButton = 'recover_changed';
