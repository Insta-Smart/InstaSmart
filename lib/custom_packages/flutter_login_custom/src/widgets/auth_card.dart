...
class AuthCardState extends State<AuthCard> with TickerProviderStateMixin {
  ...
  Widget _buildLoadingAnimator({Widget child, ThemeData theme}) {
    ...
    // loading at startup //remove this animation
...
class _LoginCardState extends State<_LoginCard> with TickerProviderStateMixin {
  ...
  Widget _buildFacebookButton(ThemeData theme, LoginMessages messages) {
    return FadeIn(
      controller: _loadingController,
      fadeDirection: FadeDirection.bottomToTop,
      offset: .5,
        ...
        child: RaisedButton(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text(
                LoginMessages.signUpWithFacebookButton,
                style: TextStyle(
                    fontSize: 18.0,
                    color: Colors.white,
                    fontFamily: 'OpenSans'),
        ...
        child: RaisedButton(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text(
                LoginMessages.signUpWithGoogleButton,
                style: TextStyle(
                    fontSize: 18.0,
                    color: Colors.white,
                    fontFamily: 'OpenSans'),
    ...
    final authForm = Form(
      ...
      child: Column(
        children: [
          ...
          Container(
            //CONTAINER FOR FORGOT PASSWORD, LOGIN, SIGNUP Buttons
            ...
            child: Column(
              children: <Widget>[
                ...
                _buildFacebookButton(theme, messages),
                _buildGoogleButton(theme, messages),
